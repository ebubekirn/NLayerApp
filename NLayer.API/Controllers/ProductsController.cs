...
namespace NLayer.API.Controllers
{
    public class ProductsController : CustomBaseController
    {
        ...
        [ServiceFilter(typeof(NotFoundFilter<Product>))] // Eğer ki bir filter ctor unda bir parametre alıyorsa mutlaka servicefilter üzerinden kullanmamız lazım. Program.cs tarafında da eklememiz lazım.
        [HttpGet("{id}")]
